...
## Описание
Необходимо изучить рынок российского кинопроката и выявить текущие тренды. Особое внимание нужно уделить картинам, которые получили государственную поддержку, узнать насколько такие картины интересны зрителю.
...
## Данные
Описания колонок 1-го датафрейма:
...
Описания колонок 2-го датафрейма:
